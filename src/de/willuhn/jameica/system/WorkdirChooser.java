...
public class WorkdirChooser
{
  ...
  public String getWorkDir()
  {
    ...
    // Zeile 1
    {
      ...
      text.setText(i18n().tr("Bitte wählen Sie den Ordner, in dem die Benutzerdaten gespeichert werden sollen."));
    ...
    // Zeile 2
    {
      ...
      dialog.setMessage(i18n().tr("Bitte wählen Sie den Ordner, in dem die Benutzerdaten gespeichert werden sollen."));
    ...
    // Zeile 4
    {
      ...
      this.check.setText(i18n().tr("Künftig immer diesen Ordner verwenden"));
    ...
    // Zeile 5
    {
      ...
      apply.setText(i18n().tr("Übernehmen"));
  ...
  private String getDir(boolean lock)
  {
    ...
    try
    {
      ...
      if (dir == null || dir.trim().length() == 0)
      {
        this.error.setText(i18n().tr("Bitte wählen Sie einen Ordner aus."));
        return null;
      }
      ...
      try
      {
        ...
        {
          this.error.setText(i18n().tr("Bitte wählen Sie einen Benutzer-Ordner, der sich außerhalb des Programm-Verzeichnisses befindet."));
          return null;
        }
      }
      catch (Exception e)
      {
        ...
        this.error.setText(i18n().tr("Benutzer-Ordner nicht auswählbar") + ": " + e.getMessage());
        return null;
      }
